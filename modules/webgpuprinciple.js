        ...
        obj.func = async () =>{
         ...
         let scalar = 1.95; 
           ...
           let spiralTrix2D = new Ebk.Geometry.SpiralTrix2D({   
              ...
              rythms: {
                angle: {type:Ebk.ERythm.TYPE.LINEAR, sample:[[0],[-18*Math.PI] ], flow:(x)=>{return 2*x; }, messy:[-1,1]},
                edge: {type:Ebk.ERythm.TYPE.WAVY, sample:[[0.008], [0.0081]], flow:(x)=>{return Math.sin(x); }, messy:[-1,1]},
                radius: {type:Ebk.ERythm.TYPE.LINEAR, sample:[[0.1], [3.9]], flow:(x)=>{return Math.pow(2.5, x); }, messy:[-1,1]},
              }
          })


            let matrixSelector =  spiralTrix2D.getCoveredCircle();
        ...
        obj.func = async () =>{
         ...
         let scalar = 1.95; 
           ...
           let circloidTrix2D = new Ebk.Geometry.CircloidTrix2D({   
            ...
            let matrixSelector =  circloidTrix2D.getCoveredCircle();
        ...
        obj.func = async () =>{
         ...
         let scalar = 1.95; 
           ...
           let circleTrix2D = new Ebk.Geometry.CircleTrix2D({   
            ...
            let matrixSelector =  circleTrix2D.getCoveredCircle();
